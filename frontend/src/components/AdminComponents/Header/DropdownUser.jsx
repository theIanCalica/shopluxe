...
import UserOne from "../../../Assets/358386321_3226460200989712_6867171037593035072_n-1712932863862-766991181.png";
...
const DropdownUser = () => {
  ...
  return (
    <div className="relative">
      ...
      >
        <ul className="flex flex-col gap-5 border-b border-gray-400 border-stroke px-6 py-7 dark:border-strokedark">
          <li>
            <Link
              to="/profile"
